<?php 
 ...
 if(isset($_POST['std_add_now']))
 {
	 ...
	 else
	 {
		 ...
		 $add_student_done = $pratima->add_student($std_fullname,$std_username,$std_password,$std_grade,$std_roll,$std_dob,$std_address,$std_district,$std_gender,$std_father,$std_mother,$std_parent_contact);
		 if($add_student_done==true)
		 {
			 echo "<script>window.location = 'home.php?pratima=student-information';</script>";
		 }
		 else
		 {
			...
			<form method="post">
				...
				<div class="vali-form">
					...
					<select name="std_grade">
						...
						<?php 
						$st_add_class = $pratima->grade($grade);
