...
$admin_username = mysqli_real_escape_string($pratima->hackme(),$_POST['admin_username']);
$admin_password = mysqli_real_escape_string($pratima->hackme(),$_POST['admin_password']);
...
{
$melogin = $pratima->meadmin_check($admin_username,$admin_password);
if($melogin==1)
{
