<?php 
 ...
 $edit_teacher_info = $pratima->edit_teacherid($teacher_id);
...
if(isset($_POST['up_teacher']))
{
	...
	$update_done = $pratima->update_teacher_info($up_fullname,$up_address,$up_email,$up_father,$up_mother,$up_dob,$up_qualification,$up_contact,$up_staff,$up_gender,$teacher_id);
	if($update_done==true)
	{
		echo "<script>window.location='home.php?pratima=teacher-information';</script>";
	}
	else
	{
...
<div class="outter-wp">
	...
	<div class="sub-heard-part">
		<ol class="breadcrumb m-b-0">
			...
			<li class="active">
				<?php if(isset($_GET['pratima'])){ echo strtoupper($page=$_GET['pratima']); } ?>
			</li>
		</ol>
	</div>
	<!--//sub-heard-part-->
	<div class="graph-visual tables-main">
		<h2 class="inner-tittle">
			<?php echo strtoupper($_GET['pratima']); ?>
		</h2>
