	<div class="outter-wp">
									<!--sub-heard-part-->
									  <div class="sub-heard-part">
									   <ol class="breadcrumb m-b-0">
											...
											<li class="active"><?php if(isset($_GET['pratima'])){ echo strtoupper($page=$_GET['pratima']); } ?></li>
										</ol>
									   </div>
								  <!--//sub-heard-part-->
									<div class="graph-visual tables-main">
											<h2 class="inner-tittle"><?php echo strtoupper($_GET['pratima']); ?></h2>
												
											<form method="post">
								<select name="class_students_data" id="selector1" class="form-control1">
							<option>Select Class</option>
													<?php 
												$opt = $pratima->grade($grade);
							...
							<option value="<?php echo $op['class']; ?>"><?php echo $op['class']; ?></option>
								...
								<input type="submit" name="students_info" class="btn red" value="View Class Data">
										...
										$student_dis_admin=	$pratima->student_info_display_admin($class_students_data);
											$s_sn = 1;
